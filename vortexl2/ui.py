...
def prompt_tunnel_config(config: TunnelConfig, side: str) -> bool:
    ...
    default_interface_ip_cidr, default_remote_forward = suggest_interface_ips(config.name, side)
    default_tunnel_id, default_peer_tunnel_id, default_session_id, default_peer_session_id = suggest_ids(config.name, side)
